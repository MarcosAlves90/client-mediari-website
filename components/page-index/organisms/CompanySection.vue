...
<template>
  ...
  >
    <div
      :class="[
        homepage__container,
        'homepage__company-content items-stretch max-w-85 w-full gap-1 flex max-lg:flex-col-reverse max-md:gap-1',
      ]"
    >
      <div
      ...
      >
        <NuxtImg
          ...
          sizes="xs:100vw sm:100vw md:100vw lg:100vw xl:300px"
          provider="cloudinary"
          ...
          preload
          fit="cropping"
          :modifiers="{ gravity: 'south' }"
          @click="
            openLinkInBrowser(
              'https://www.google.com/maps/@-23.6147637,-46.5694789,0a,22.3y,65.04h,95.74t/data=!3m4!1e1!3m2!1sEP5Wtm-s9EVnSAi5PEfDvw!2e0?source=apiv3'
            )
          "
      ...
      <div class="homepage__company-info flex flex-col p-0">
        ...
        <div
          class="homepage__company-info-location mt-0.5 gap-0.5 flex items-center justify-start text-secondary-text p-0"
          role="group"
        ...
        >
          <Icon
            ...
            @click="
              openLinkInBrowser('https://maps.app.goo.gl/8f6BACTToivurF4h9')
            "
            aria-label="Abrir localização no Google Maps"
          />
          <p
            class="homepage__section_description !m-0"
            :class="homepage__section_description"
          >
            {{ t('enterprise.location', { address: '' })
            }}<span class="font-medium"
              >Rua Amazonas, 439 - Centro, São Caetano do Sul, 09520070</span
            >.
          </p>
        </div>
